object Deps {
    ...
    private const val apolloVersion = "3.7.4"
    const val apolloRuntime = "com.apollographql.apollo3:apollo-runtime:$apolloVersion"
    const val apolloGradlePlugin = "com.apollographql.apollo3:apollo-gradle-plugin:$apolloVersion"
    ...
    const val composeMaterial = "androidx.compose.material3:material3:1.1.0-beta02"
    ...
    private const val gradleVersion = "8.1.0-alpha09"
